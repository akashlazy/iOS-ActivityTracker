...
public enum MKTimingFunction {
    ...
    public var function: CAMediaTimingFunction {
        switch self {
        case .linear:
            return CAMediaTimingFunction(name: convertToCAMediaTimingFunctionName("linear"))
        case .easeIn:
            return CAMediaTimingFunction(name: convertToCAMediaTimingFunctionName("easeIn"))
        case .easeOut:
            return CAMediaTimingFunction(name: convertToCAMediaTimingFunctionName("easeOut"))
