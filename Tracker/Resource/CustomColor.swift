...
//  RigvApp
//
//  Created by Swapnil Jambhulkar on 02/09/15.
...
//    FF002366
    ...
    class func colorPrimaryDark() -> UIColor {
        return UIColor(rgba: "#061B44ff")
    }
    class func colorAccent() -> UIColor {
        return UIColor(rgba: "#0171C9FF")
    }
    ...
    /*
    class func progress_colors() -> UIColor {
   ...
   // <!-- Gyroscope color -->
    class func gyroscopeRippleColor() -> UIColor {
        return UIColor(rgba: "#80ff00")
    }
    class func rippelColor() -> UIColor {
        return UIColor(rgba: "#0099CC")
    }
    class func gyroscopeDarkColor() -> UIColor {
        return UIColor(rgba: "#6cae2a")
    }
   ...
   // <!-- Flurocent color -->
    ...
    class func binocular() -> UIColor {
        return UIColor(rgba: "#640264FF")
    }
    
    class func spot() -> UIColor {
        return UIColor(rgba: "#fb9903FF")
    }
    
    class func navigation() -> UIColor {
        return UIColor(rgba: "#03319bFF")
    }
    
    class func compass() -> UIColor {
        return UIColor(rgba: "#fb3103FF")
    }
    
    class func followme() -> UIColor {
        return UIColor(rgba: "#fb6605FF")
    }
    
    class func heyThere() -> UIColor {
        return UIColor(rgba: "#80c080FF")
    }
    
    class func buzz() -> UIColor {
        return UIColor(rgba: "#f15f74FF")
    }
    
    class func addAddr() -> UIColor {
        return UIColor(rgba: "#24aceaFF")
    }
    
    class func share() -> UIColor {
        return UIColor(rgba: "#046564FF")
    }
    
    class func odometer() -> UIColor {
        return UIColor(rgba: "#252525FF")
    }
    
    class func passenger() -> UIColor {
        return UIColor(rgba: "#F6AE2CFF")
    }
    
    class func antiTheft() -> UIColor {
        return UIColor(rgba: "#792839FF")
    }
    
    class func secureMode() -> UIColor {
        return UIColor(rgba: "#AA0000FF")
    }
    ...
    class func colorGyroscope(_ index: Int) -> UIColor {
        if index == 0 {
            return UIColor(rgba: "#D8433CFF")
        } else if index == 1 {
            return UIColor(rgba: "#F2AF3AFF")
